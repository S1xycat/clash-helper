...
- Show system proxy switch, current Clash region, and measured delay.
- Read Clash for Windows / Clash API state automatically.
- Toggle Windows system proxy and sync Clash for Windows `connProxy`.
